...
3） 此工程可以跑起来测试，建议使用chrome、firefox打开。
  全渠道代付产品示例地址为：http://IP：端口/upacp_demo_df/index_10_df.php
───────────
...
upacp_demo_df
  ...
  │  ├批量文件样例
  │  │  │
  │  │  └DF00000000777290058110097201507140002I.txt┈┈┈┈┈┈┈┈┈批量代付文件样例（使用前请注意按照规范修改里面的字段）
  │  │  
  │  ├测试环境证书
  │  │  │  
  ...
  │      │  
  │      ├Form_6_2_DF.php ┈┈┈┈┈ 代付示例类（后台）
  │      │  
  │      ├Form_6_3_Query.php ┈┈┈┈┈ 交易状态查询示例类（后台）
  │      │  
  │      ├Form_6_4_RealAuth_Back.php ┈┈┈┈┈ 实名认证示例类（后台）
  │      │  
  │      ├Form_6_4_RealAuth_Front.php ┈┈┈┈┈ 实名认证示例类（前台）
  │      │  
  │      ├Form_6_5_BatTrans.php ┈┈┈┈┈ 批量代付示例类（后台）
  │      │  
  │      ├Form_6_6_BatTransQuery.php ┈┈┈┈┈ 批量代付查询示例类（后台）
  │      │  
  │      ├Form_7_2_FileTransfer.php┈┈┈┈┈对账文件下载示例类 （后台）  
  │      │   
