var
  GET_DATA_API = '../Seller/queryTicket',
  UPDATE_API = '../Seller/alertTicket',
  DEL_API = '../Seller/delTicket',
  CNT = new Vue({
    el: '#pageWrapper',
    data: {
      tableData: [],
      ...
      searchKey: '',
      searchType: '1',
      searchTypeArr: [{id: '1', name: '有效期内'}, {id: '2', name: '已过期'}],
      showPageNav: !0,
      curPage: 1,
      pageCount: 1
    },
