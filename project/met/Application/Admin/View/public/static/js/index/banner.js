var
        GET_DATA_API = 'getBannerList',
        SET_DATA_API = 'setBanner',
        ADD_DATA_API = 'addBanner',
        DEL_DATA_API = 'delBanner',
        MET = new Vue({
            el: '#wrapper',
            data: {
                tableData: [],
            ...
            methods: {
                ...
                showEdit: function (idx) {
                    ...
                    if (idx != -1) {
                        ...
                        this.editobj.path = _dt.path;
                        this.editobj.jump = _dt.jump;
...
$(function () {
    ...
    $('#banner').parents('.dropdown').addClass('open');
    $('#pathView').click(function () {
        $('#path').click();
    });
    var pathView = new uploadPreview({
        UpBtn: 'path',
        ImgShow: 'pathView',
        ImgType: ['jpg', 'png'],
