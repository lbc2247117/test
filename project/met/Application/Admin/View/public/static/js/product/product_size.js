var
        GET_DATA_API = 'getProductSizeList',
        SET_DATA_API = 'setProductSize',
        ADD_DATA_API = 'addProductSize',
        DEL_DATA_API = 'delProductSize',
        UP_DATA_API = 'upProductSize',
        DOWN_DATA_API = 'downProductSize',
        MET = new Vue({
            el: '#wrapper',
            data: {
                tableData: [],
            ...
            methods: {
                ...
                delBanner: function () {
                    ...
                    BASE.showConfirm('将会删除所选记录及其参数记录，确定删除吗?', function () {
                        $('#loading').show();
                ...
                showParam: function (id) {
                    window.location.href = 'product_param.html?id=' + MET.pid + '&sid=' + id;
                },
