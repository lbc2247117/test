var
        GET_DATA_API = 'getAdminList',
        ADD_DATA_API = 'addAdmin',
        DEL_DATA_API = 'delAdmin',
        MET = new Vue({
            el: '#wrapper',
            data: {
                tableData: [],
            ...
            methods: {
                ...
                saveData: function () {
                    if (MET.isLock)
                        return false;
                    if (MET.editobj.username.trim() == '') {
                        BASE.showAlert('请输入用户名');
                        return false;
                    }
                    if (MET.editobj.password.trim() == '') {
                    ...
                    $('#editform').ajaxSubmit({
                        ...
                        data: {
                            password: hex_md5(MET.editobj.password),
                        },
...
MET.init();
$(function () {
    $('#menber').addClass('open');
    $('#menber').parents('.dropdown').addClass('open');
});