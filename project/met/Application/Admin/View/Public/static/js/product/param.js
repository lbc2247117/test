var
        GET_DATA_API = 'getParamTypeList',
        SET_DATA_API = 'setParamType',
        ADD_DATA_API = 'addParamType',
        DEL_DATA_API = 'delParamType',
        MET = new Vue({
            el: '#wrapper',
            data: {
                tableData: [],
...
MET.init();
$(function () {
    $('#product-param').addClass('open');
    $('#product-param').parents('.dropdown').addClass('open');
});