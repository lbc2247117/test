...
<div id="pageTitle">
    <div class="page-title">首页banner管理</div>
</div>
<div id="pageWrapper">
    <div id="searchCnr">
                ...
                <div class="cnt-body">
                    <form id="editform" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <img  id="pathView" :src="editobj.path" width="300" onerror="this.src='/Public/img/error_scepic.png'" style="cursor: pointer;">
                                <label class="lable-aaa"><span class="red">●</span> 请上传1920px*560px比例的图片</label>
                                <input type="file" hidden="hidden" name="path" id="path">
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-sm-2 control-label">跳转链接</label>
                            <div class="col-sm-10">
                                <input type="text" name="jump" class="form-control" v-model="editobj.jump" placeholder="跳转链接">
                            </div>
                        </div>
                        <div class="form-group">
...
<?php $str = "/Public/js/uploadPreview.js,/Public/js/vue.min.js,/Public/js/jquery.form.js,/Application/Admin/View/public/static/js/index/banner.js"; $arr = explode(",", $str); ?>
