                ...
                <div class="cnt-body">
                    <form id="editform" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <img  id="goodPicView" :src="editobj.goodPic" width="300" onerror="this.src='/Public/img/error_scepic.png'" style="cursor: pointer;">
...
<?php $str = "/Public/js/uploadPreview.js,/Public/js/vue.min.js,/Public/js/jquery.form.js,/Application/Admin/View/Public/static/js/product/index.js"; $arr = explode(",", $str); ?>
