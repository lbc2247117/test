...
var FinalRankModel = new function ()
{
    var self_ = this;
    self_.rankList = ko.observableArray([]);
    self_.listRank = function (data) {
        ycoa.ajaxLoadGet("/api/finance/final_sale_checking_rank.php", data, function (results) {
            debugger
            self_.rankList.removeAll();
            $("#showDate").html(results.currentDate);
...
$(function () {
    ...
    /*给页面绑定数据*/
    ko.applyBindings(FinalRankModel, $("#dataTable")[0]);
