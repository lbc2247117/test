...
$(function () {
    ...
    $("body").on("click", '.second_table #username', function () {
    ...
    //导入迟到记录
    $('#btn_importlateexcel_primary').click(function () {
        ycoa.UI.block.show();
        $('#importlateexcel_form').ajaxSubmit({
            type: 'post',
            url: "../../api/attendance/late.php?upload=1",
            success: function (result) {
                ...
                $('#myImportLateexcelModal').modal('hide');
            }
        });
    });
