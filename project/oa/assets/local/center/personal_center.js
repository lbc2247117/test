...
function bindEvent() {
    ...
    var d = [1, 2];
    if ($.inArray(ycoa.user.dept1_id(),d) == -1) {
    ...
    $("body").on('click','.div_comment_placeholder',function () {
        $(this).hide();
    ...
    $("body").on('blur','.div_comment_write_info',function () {
    ...
    $("body").on("click",'.div_daily_share_btn',function (e) {
    ...
    $("body").on('click','.send_comment_btn',function () {
        var self = $(this);
    ...
    $("body").on("mouseenter",'.div_daily_share_reply_right_botton,.div_daily_share_reply_second_right',function () {
        $(this).find(".div_daily_share_btn_delete img").show();
    }).on("mouseleave",$(this),function () {
        $(this).find(".div_daily_share_btn_delete img").hide();
    });
    $("body").on("mouseenter",".div_daily_share_context_name",function () {
    ...
    $("body").on("click",".div_daily_share_btn_delete",function () {
        var self_ = $(this);
    ...
    $("body").on('click',".div_talk_btn_delete",function () {
        var self_ = $(this);
    ...
    $("body").on('mouseenter','.div_comment_outer',function () {
    ...
    $("body").on("click",".div_daily_share_content img",function () {
        $(".img_view").css({left: '', top: ''});
    ...
    $("body").on("mousewheel",".photo_layer",function (event, delta, deltaX, deltaY) {
...
function createEMPanel() {
    ...
    $("body").on('click',".expression_btn",function (e) {
        if ($(this).attr('v')) {
...
function dropUploadImage() {
    ...
    $("body").on('dragend','img',function (e) {  //拖后放
        if (dragenter) {
            $("#div_write_info").append("<img src='" + ($(this).attr("src")) + "'>");
            dragenter = false;
        }
    });
    var box =$("#div_write_info");  //document.getElementById('div_write_info'); //拖拽区域
    ...
    $("body").on("click",".upload_image_btn",function () {
