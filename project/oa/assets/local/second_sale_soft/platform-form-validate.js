$('#add_platform_form').validate({
    ...
    submitHandler: function (form) {
        var data = $("#add_platform_form").serializeJson();
        data.action = 1;
        ycoa.ajaxLoadPost("/api/second_sale_soft/platform.php", JSON.stringify(data), function (result) {
            if (result.code == 0) {
...
$('#add_fillarrears_form').validate({
    ...
    submitHandler: function (form) {
        ...
        data.action = 1;
        data.type = 1;
        ycoa.ajaxLoadPost("/api/second_sale_soft/fillarrears.php", JSON.stringify(data), function (result) {
            if (result.code == 0) {
