$('#add_physica_form').validate({
    ...
    submitHandler: function (form) {
        var data = $("#add_physica_form").serializeJson();
        data.action = 1;
        ycoa.ajaxLoadPost("/api/second_sale_soft/physica.php", JSON.stringify(data), function (result) {
            if (result.code == 0) {
