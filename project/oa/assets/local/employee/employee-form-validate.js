    ...
    submitHandler: function (form) {
        ...
        ycoa.ajaxLoadPost("/api/user/employee.php", data, function (result) {
            if (result.code == 0) {
                ...
                reLoadData({mouth: $('#mouth').val(), pageno: ycoa.SESSION.PAGE.getPageNo(), pagesize: ycoa.SESSION.PAGE.getPageSize(), deptid: $('#deptid').val(), status: $("#status").val(), searchName: $("#searchUserName").val(), sort: ycoa.SESSION.SORT.getSort(), sortname: ycoa.SESSION.SORT.getSortName()});
