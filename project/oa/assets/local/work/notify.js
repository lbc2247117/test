    ...
    self_.listNotify = function (data) {
        ycoa.ajaxLoadGet("/api/work/notify.php", data, function (results) {
            ...
            $.each(results.list, function (index, notify) {
                notify.addtime = notify.addtime.split(' ')[0];
                notify.dele = ycoa.SESSION.PERMIT.hasPagePermitButton("3080104");
                notify.edit = ycoa.SESSION.PERMIT.hasPagePermitButton("3080103");
                notify.show = ycoa.SESSION.PERMIT.hasPagePermitButton("3080101");
