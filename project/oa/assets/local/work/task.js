...
var TaskListViewModel = new function () {
    ...
    self_.listTask = function (data) {
        ycoa.ajaxLoadGet("/api/work/task.php", data, function (results) {
...
var array = {
    ...
    status: [{id: "", text: '全部'}, {id: 0, text: '新添加'}, {id: 1, text: '未开始'}, {id: 2, text: '已开始'}, {id: 3, text: '已完成'}, {id: 4, text: '已驳回'}, {id: 5, text: '已终止'}, {id: 6, text: '已重启'}, {id: -1, text: '已删除'}]
};