    ...
    self_.listcomplaintRecord = function (data) {
        ycoa.ajaxLoadGet("/api/sale_soft/complaint_record.php", data, function (results) {
            ...
            $.each(results.list, function (index, complaintRecord) {
                complaintRecord.dele = ycoa.SESSION.PERMIT.hasPagePermitButton("2011402");
                complaintRecord.edit = ycoa.SESSION.PERMIT.hasPagePermitButton("2011403");
                complaintRecord.show = ycoa.SESSION.PERMIT.hasPagePermitButton("2011404");
