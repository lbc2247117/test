    ...
    self_.listRefund = function (data) {
        ycoa.ajaxLoadGet("/api/sale_soft/refund.php", data, function (results) {
            ...
            $.each(results.list, function (index, refund) {
                ...
                refund.dele = ycoa.SESSION.PERMIT.hasPagePermitButton("3030502");
                refund.edit = ycoa.SESSION.PERMIT.hasPagePermitButton("3030503");
                refund.show = ycoa.SESSION.PERMIT.hasPagePermitButton("3030505");
