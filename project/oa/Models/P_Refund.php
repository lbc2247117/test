...
*
* @author 自动生成的实体类
* @copyright (c) 2015, 达州非时序电子商务有限公司
* @version 1.0
*/
...
class p_refund extends Model{
	...
	static function init_schema() {
		...
		self::$field_money = Model::define_field('money', 'string', 0.00);
		self::$field_retrieve = Model::define_field('retrieve', 'string', NULL);
		self::$field_refund_rate = Model::define_field('refund_rate', 'string', NULL);
		self::$field_ind_refund_rate = Model::define_field('ind_refund_rate', 'string', NULL);
		self::$field_totalmoney = Model::define_field('totalmoney', 'string', NULL);
		...
		self::$field_record_amount = Model::define_field('record_amount', 'string', NULL);
