...
$GLOBALS['/Models/P_Upgrade_soft.php'] = 1;

use Models\Base\Model;

class P_Upgrade_soft extends Model{

	public static $field_id;
	public static $field_name;
	public static $field_ww;
	public static $field_mobile;
	public static $field_upgrade_sum;
	...
	static function init_schema() {
		...
		self::$field_upgrade_sum = Model::define_field('upgrade_sum', 'float', 0.00);
		...
		self::$MODEL_SCHEMA = Model::build_schema('P_Upgrade_soft', array(
			self::$field_id,
			self::$field_name,
			self::$field_ww,
			self::$field_mobile,
			self::$field_upgrade_sum,
			self::$field_add_time,
			self::$field_add_name,
			self::$field_payment,
			self::$field_channel,
	...
	public function get_upgrade_sum() {
		return $this->get_field_value(self::$field_upgrade_sum);
	}

	public function set_upgrade_sum($upgrade_sum) {
		$this->set_field_value(self::$field_upgrade_sum, $upgrade_sum);
	}
	...
	public function to_array(array $options = array(), callable $func = NULL) {
		...
		//unset($arr[self::$field_upgrade_sum['name']]);
