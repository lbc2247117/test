...
$GLOBALS['/Models/E_System.php'] = 1;

use Models\Base\Model;

class E_System extends Model {
    ...
    static function init_schema() {
        ...
        self::$field_userid = Model::define_field('userid', 'int', NULL);
        self::$MODEL_SCHEMA = Model::build_schema('e_system', array(
                    self::$field_id,
