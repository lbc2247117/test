...
$GLOBALS['/Models/P_Salecount_soft.php'] = 1;

use Models\Base\Model;

class P_Salecount_soft extends Model{
	...
	static function init_schema() {
		...
		self::$field_c_shop = Model::define_field('c_shop', 'string', NULL);
		...
		self::$MODEL_SCHEMA = Model::build_schema('P_Salecount_soft', array(
			self::$field_id,
			self::$field_addtime,
			self::$field_ww,
			self::$field_name,
	...
	public function get_c_shop() {
		return $this->get_field_value(self::$field_c_shop);
	}

	public function set_c_shop($c_shop) {
		$this->set_field_value(self::$field_c_shop, $c_shop);
	}
	...
	public function to_array(array $options = array(), callable $func = NULL) {
		...
		//unset($arr[self::$field_c_shop['name']]);
