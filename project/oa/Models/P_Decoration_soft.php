...
$GLOBALS['/Models/p_decoration_soft.php'] = 1;

use Models\Base\Model;

class p_decoration_soft extends Model{
	...
	public static $field_alipay_tran_num;
	...
	static function init_schema() {
		...
		self::$field_alipay_tran_num = Model::define_field('alipay_tran_num', 'string', NULL);
		...
		self::$MODEL_SCHEMA = Model::build_schema('p_decoration_soft', array(
			self::$field_id,
			self::$field_is_edit,
			self::$field_add_time,
			self::$field_ww,
	...
	public function get_alipay_tran_num() {
		return $this->get_field_value(self::$field_alipay_tran_num);
	}

	public function set_alipay_tran_num($alipay_tran_num) {
		$this->set_field_value(self::$field_alipay_tran_num, $alipay_tran_num);
	}
	...
	public function to_array(array $options = array(), callable $func = NULL) {
		...
		//unset($arr[self::$field_alipay_tran_num['name']]);
