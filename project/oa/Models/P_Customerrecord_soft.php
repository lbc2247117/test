...
$GLOBALS['/Models/P_Customerrecord_soft.php'] = 1;

use Models\Base\Model;

class P_Customerrecord_soft extends Model{
	...
	static function init_schema() {
		...
		self::$MODEL_SCHEMA = Model::build_schema('P_Customerrecord_soft', array(
			self::$field_id,
			self::$field_userid,
			self::$field_username,
			self::$field_nickname,
...
P_Customerrecord_soft::init_schema();
