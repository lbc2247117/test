...
$GLOBALS['/Models/P_Customerrecord_second_soft.php'] = 1;

use Models\Base\Model;

class P_Customerrecord_second_soft extends Model{
	...
	static function init_schema() {
		...
		self::$MODEL_SCHEMA = Model::build_schema('P_Customerrecord_second_soft', array(
			self::$field_id,
			self::$field_type,
			self::$field_userid,
			self::$field_username,
...
P_Customerrecord_second_soft::init_schema();
