...
$GLOBALS['/Models/st_fills_second.php'] = 1;

use Models\Base\Model;

class st_fills_second extends Model {

    public static $field_id;
    public static $field_addtime;
    public static $field_qq;
    public static $field_se_id;
    ...
    static function init_schema() {
        ...
        self::$field_se_id = Model::define_field('se_id', 'int', 0);
        ...
        self::$MODEL_SCHEMA = Model::build_schema('st_fills_second', array(
                    self::$field_id,
                    self::$field_addtime,
                    self::$field_qq,
                    self::$field_se_id,
    ...
    public function get_se_id() {
        return $this->get_field_value(self::$field_se_id);
    }

    public function set_se_id($se_id) {
        $this->set_field_value(self::$field_se_id, $se_id);
    }
