...
$user = new M_User();
$user->set_query_fields(array(M_User::$field_userid, M_User::$field_sex, M_User::$field_employee_no, M_User::$field_username, M_User::$field_dept1_id, M_User::$field_dept2_id, M_User::$field_role_id, M_User::$field_join_time, M_User::$field_status, M_User::$field_permit));
$user->set_where_and(M_User::$field_status, SqlOperator::In, explode(",", "-1,1,2"));
...
$result = Model::list_to_array($result['models'], array(), function (&$d) use($str2py, $letter_group_map, $roles, &$managers) {
            $d['id'] = $d['userid'];
            $d['py'] = $str2py->getInitials($d['username']);
