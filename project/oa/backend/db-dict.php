...
$db = $pdo;
$result = Model::execute($db, "SELECT TABLE_NAME, COLUMN_NAME, COLUMN_TYPE, COLUMN_DEFAULT, IS_NULLABLE, COLUMN_KEY, EXTRA, COLUMN_COMMENT FROM `COLUMNS` WHERE TABLE_SCHEMA = 'yc_oa';");
